 ...
 * a student or parent uses {@code /api/v1/me/...}. 404 if the section does not
...
public class SectionStudentsController {
    ...
    PagedModel<StudentResponse> studentsInSection(@PathVariable UUID sectionId,
        ...
        return new PagedModel<>(studentService.listInSection(sectionId, pageable).map(StudentResponse::from));
    }
}
